...
class RestHelp
{
     ...
     * @return string
     */
    public static function tokenErr()
    {
        return self::encodeResult(20000,'Permission denied');
    }

    public static function weixinErr($str)
    {
        return self::encodeResult(90000,'weixin error',['wx_error_message'=>$str]);
    }
    /**
     * 统一返回格式
     * @param $msgcode
