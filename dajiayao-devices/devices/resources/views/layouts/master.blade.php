...
<head>
    ...
    <!-- Title -->
    <title>@yield('title') - 丫摇设备中心</title>
    ...
    <link href="/themeforest/css/themes/white.css" class="theme-color" rel="stylesheet" type="text/css"/>
    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;">
        <div class="slimscroll" style="overflow: hidden; width: auto; height: 100%;">
            <a href="javascript:void(0);" class="showRight2">
                <img src="/themeforest/images/avatar5.png" alt="">
        ...
        <div class="slimscroll chat" style="overflow: hidden; width: auto; height: 100%;">
            <div class="chat-item chat-item-left">
                <div class="chat-image">
                    <img src="/themeforest/images/avatar2.png" alt="">
                </div>
...
<main class="page-content content-wrap">
    <div class="navbar">
        <div class="navbar-inner">
            ...
            <div class="logo-box">
                <a href="/" class="logo-text"><span>丫摇设备中心</span></a>
            </div><!-- Logo Box -->
            ...
            <div class="topmenu-outer">
                <div class="top-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                <span class="user-name">{{{\Illuminate\Support\Facades\Auth::user()->username}}}<i class="fa fa-angle-down"></i></span>
                                <img class="img-circle avatar" src="/themeforest/images/avatar.png" width="40" height="40" alt="">
                            </a>
                            <ul class="dropdown-menu dropdown-list" role="menu">
                                <li role="presentation"><a href="{{route('updatePassword',array('id'=>\Illuminate\Support\Facades\Auth::user()->id))}}"><i class="fa fa-user"></i>修改密码</a></li>
    ...
    <div class="page-sidebar sidebar">
        <div class="page-sidebar-inner slimscroll">
            ...
            <ul class="menu accordion-menu">
                <li class="active"><a href="/admin" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>主页</p></a></li>
                @if(\Illuminate\Support\Facades\Auth::user()->role==\Dajiayao\User::ROLE_ADMIN)

                <li class="droplink open"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-hdd"></span><p>设备</p><span class="arrow"></span></a>
                    <ul class="sub-menu" style="display: block;">
                        <li><a href="{{route('adminDevices')}}">iBeacon</a></li>
                        <li><a href="{{route('manufacturers')}}">厂商列表</a></li>
                        <li><a href="{{route('deviceModels')}}">型号列表</a></li>
                    </ul>
                </li>
            @endif

                <li class="droplink open"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-cloud"></span><p>应用</p><span class="arrow"></span></a>
                    <ul class="sub-menu" style="display: block;">
                        <li><a href="{{route('adminWxDevicesIndex')}}">微信设备ID</a></li>
                        <li><a href="{{route('adminWxPages')}}">摇一摇页面</a></li>
                        <li><a href="{{route('apps')}}">接入的应用</a></li>
                    </ul>
                </li>
                @if(\Illuminate\Support\Facades\Auth::user()->role==\Dajiayao\User::ROLE_ADMIN)
                <li class="droplink open"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-user"></span><p>用户</p><span class="arrow"></span></a>
                    <ul class="sub-menu" style="display: block;">
                        <li><a href="{{route('users')}}">用户列表</a></li>
                    </ul>
                </li>
                @endif
                <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-wrench"></span><p>系统</p><span class="arrow"></span></a>
                    <ul class="sub-menu" style="display: block;">
                        <li><a href="{{route('adminSyncWeixin')}}">同步微信</a></li>
                    </ul>
                </li>
