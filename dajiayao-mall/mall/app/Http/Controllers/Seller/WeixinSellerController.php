...
namespace Dajiayao\Http\Controllers\Seller;

use Dajiayao\Http\Controllers\WeixinController;
use Dajiayao\Model\WxUser;
use Dajiayao\Services\WxUserService;
use Illuminate\Support\Facades\Input;

class WeixinSellerController extends WeixinController
{
    ...
    protected function handleClickAboutMenu($message)
    {
        ...
        return $this->respondTextMsg($fromUser, "About seller weixin", $toUser);
    }
    ...
    protected function handleSubscribeEvent($message)
    {
        ...
        $wxUser = $this->getSubscribeUser($fromUserName, $this->mq->getWeixinAccessTokenByName(self::WX_ACCOUNT_SELLER), WxUser::ROLE_SELLER);
        return $this->respondTextMsg($fromUserName, '你好，欢迎关注丫摇店主。', $message->ToUserName);
    }
