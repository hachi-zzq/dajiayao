...
<div class="sans shop trailingSpace">
    <header class="navigation navigationWithToolbar">
        ...
        <nav class="toolbar trisected clearfix"><a href="{{route('favoriteIndex')}}" class="toolDrawer ">我收藏的</a><a href="{{route('myBuyedShop')}}" class="toolDrawer">我买过的</a><a href="{{route('myBrowseShop')}}" class="toolDrawer toolDrawerOpen">最近浏览</a></nav>
    </header>
